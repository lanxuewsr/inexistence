...
```
bash <(wget --no-check-certificate -qO- https://github.com/lanxuewsr/inexistence/raw/master/inexistence.sh) \
...
``` shell
bash <(wget -qO- https://github.com/lanxuewsr/inexistence/raw/master/00.Installation/script/ipv6.sh) -6 [address] -d [DUID] -s [subnet]
```
